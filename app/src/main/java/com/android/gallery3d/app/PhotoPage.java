...
//        mHaveImageEditor = GalleryUtils.isEditorAvailable(mActivity, "image/*");
    ...
    protected boolean onItemSelected(MenuItem item) {
        ...
        if (action == android.R.id.home) {
            ...
            launchPhotoEditor();
            return true;
        } else if (action == R.id.action_simple_edit) {
            launchSimpleEditor();
            return true;
            ...
            return true;
        } else if (action == R.id.action_setas || action == R.id.action_rotate_ccw || action == R.id.action_rotate_cw || action == R.id.action_show_on_map) {
            mSelectionManager.deSelectAll();
            mSelectionManager.toggle(path);
            mMenuExecutor.onMenuClicked(item, confirmMsg, mConfirmDialogListener);
            return true;
